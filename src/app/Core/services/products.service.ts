...
export class ProductsService {
  ...
  getProductDetails(_id:string|null):Observable<any>{
    return this._HttpClient.get(this.baseUrl+`products/${_id}`)
  }

  getCategories():Observable<any>{
    return this._HttpClient.get(this.baseUrl+'categories')
  }
  getCategoriesDetail(id:string|null):Observable<any>{
